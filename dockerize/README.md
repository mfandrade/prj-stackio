...
This is your first task in out assignment. Here you are supposed to build a
Dockfile with a Go Webserver within.

**Dockerize** is the first task in the [Stack.io's](https://stack.io) test assignment.

It contains a simple webserver application written in Go which serves a thin
client web application that implements a very basic blog.

## Objective

The main objective is to simulate a real world scenario to prepare the
