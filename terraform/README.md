...
- Create a Terraform script named `main.tf` to:
  ...
  - Load the `app.yaml` from your last task in this module and apply it to your
    `minukube` context;
...
Please, provide us with the `terraform.state` file that was created when you ran
`terraform apply`;
